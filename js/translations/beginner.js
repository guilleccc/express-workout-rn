...
export const basicTranslations = {
  en: {
    ...
    home: {
      ...
      beginnerText: "Basic exercises for people who do not train often.",
      intermediateText: "Exercises for people whoes do workout sometimes.",
      quote1: "I can ",
      quote2: "... and I will.",
    },
    selectRoutine: {
      ...
      time: "Time",
      select: "Select",
      explanation: "Each exercise will take around",
      seconds: "seconds",
      minute: "minute",
    },
    videoPage: {
  ...
  fr: {
    ...
    home: {
      ...
      beginnerText: "Exercices de base pour les personnes qui ne s'entraînent pas souvent",
      intermediateText: "Exercices pour les personnes qui font de l'entraînement parfois.",
      quote1: "Je peux",
...
      time: "Temps",
      select: "Sélectionner",
      explanation: "Chaque exercice prendra environ",
      seconds: "secondes",
      minute: "minute",
    },
    videoPage: {
...
                   "Soulevez un bras et une jambe à la fois. Éloignez simplement votre jambe et le bras opposé",
  ...
  es: {
    ...
    home: {
      ...
      beginnerText: "Ejericios básicos para gente que no entrena a menudo.",
      intermediateText: "Ejecicios para gente que realiza entrenamiento regularmente.",
      quote1: "Yo puedo ",
      quote2: "... Y lo haré.",
    },
    selectRoutine: {
      ...
      time: "Tiempo",
      select: "Seleccionar",
      explanation: "Cada ejercicio durará",
      seconds: "segundos",
      minute: "minuto",
    },
    videoPage: {
